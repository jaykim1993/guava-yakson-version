...
const FireIcon = getIcon("FireSimple");
// const HeartBeat = getIcon("Heartbeat");
// const ArticleIcon = getIcon("ArticleIcon");
    ...
    <section className="doctor section">
      ...
      <blockquote className="doctor-quote">
        ...
        <p className="doctor-quote-sub">
          환자 한 말씀 한 말씀을 경청하며,<br/>바른 치료와 좋은 한약재로<br/>정성껏 진료하겠습니다.
        </p>
      </blockquote>
